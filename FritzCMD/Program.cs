    ...
    class Program
    {
        ...
        public static void getDeviceList(FritzBox box, Parameter parameter)
        {
            try
            {
                ...
                {
                    Console.WriteLine(device.GetType().ToString().Replace("FritzHome.", "").PadLeft(12, ' ') + ":\t" + device.DeviceName);
                }
            }
            catch (Exception Ex)
            {
        ...
        public static void getSwitch(FritzBox box, Parameter parameter)
        {
            try
            {
                ...
                using (SmartDevice device = box.Devices.Find(x => x.DeviceName.Equals(parameter.Arguments["Device"])))
                {
                    ...
                    {
                        Console.WriteLine(device.GetType().ToString().Replace("FritzHome.", "").PadLeft(12, ' ') + ":\t" + device.DeviceName + "\t" + "On");
                    }
                    else
                    {
                        Console.WriteLine(device.GetType().ToString().Replace("FritzHome.", "").PadLeft(12, ' ') + ":\t" + device.DeviceName + "\t" + "Off");
                    }
                }
            }
            catch (Exception Ex)
        ...
        public static void setSwitch(FritzBox box, Parameter parameter)
        {
            try
            {
                ...
                using (SmartDevice device = box.Devices.Find(x => x.DeviceName.Equals(parameter.Arguments["Device"])))
                {
                    ...
                    {
                        Console.WriteLine(device.GetType().ToString().Replace("FritzHome.", "").PadLeft(12, ' ') + ":\t" + device.DeviceName + "\t" + "Unknowen");
                    }
                }
            }
            catch (Exception Ex)
        ...
        public static void getTemperatur(FritzBox box, Parameter parameter)
        {
            try
            {
                ...
                using (SmartDevice device = box.Devices.Find(x => x.DeviceName.Equals(parameter.Arguments["Device"])))
                {
                    ...
                    Console.WriteLine(device.GetType().ToString().Replace("FritzHome.", "").PadLeft(12, ' ') + ":\t" + device.DeviceName + "\t" + device.Temperature.ToString() + "°C");
                }
            }
            catch (Exception Ex)
            {
        ...
        public static void getBattery(FritzBox box, Parameter parameter)
        {
            try
            {
                ...
                {
                    //device.getTemperatureAsync(box.Uri, box.SID);
                    Console.WriteLine(device.GetType().ToString().Replace("FritzHome.", "").PadLeft(12, ' ') + ":\t" + device.DeviceName + "\t" + device.Battery.ToString() + "%");
                }
            }
            catch (Exception Ex)
            {
